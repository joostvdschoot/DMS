...
<html>
    ...
    <body>
        ...
        <div id="show-subcategory" class="content scaffold-show" role="main">
            ...
            <f:display bean="subcategory" />
            <g:form resource="${this.subcategory}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.subcategory}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
