...
<html>
    ...
    <body>
        ...
        <div id="show-object" class="content scaffold-show" role="main">
            ...
            <f:display bean="object" />
            <g:form resource="${this.object}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.object}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
