...
<html>
    ...
    <body>
        ...
        <div id="show-folder" class="content scaffold-show" role="main">
            ...
            <f:display bean="folder" />
            <g:form resource="${this.folder}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.folder}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
